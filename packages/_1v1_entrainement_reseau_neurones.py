...
from ._1v1_parametres_reseau_neurones import N_STEP, NB_SAMPLES_MAX, NB_SAMPLES_DEBUT_ENTRAINEMENT, TAILLE_BATCHS, NB_ENTRAINEMENT_BATCH, gamma, learning_rate, ACTU_W_TARGET, PERIODE_STOCKAGE_PC, MAX_NORME_GRADIENT, DELTA_HUBER_LOSS
...
class Reseau_neurones:
    def __init__(self, nom_fichier, TAILLE_STATE, NB_ACTIONS_POSSIBLES, NB_NEURONES_LAYER1, NB_NEURONES_LAYER2):
        ...
        try:
            ...
            self.W1 = np.random.randn(self.NB_NEURONES_LAYER1, self.TAILLE_STATE) * 0.01  # He init pour ReLU
            self.W2 = np.random.randn(self.NB_NEURONES_LAYER2, self.NB_NEURONES_LAYER1) * 0.01
            self.W3 = np.random.randn(self.NB_ACTIONS_POSSIBLES, self.NB_NEURONES_LAYER2) * 0.01
